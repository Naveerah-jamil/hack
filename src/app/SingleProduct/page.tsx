  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-start w-full h-auto mt-10">
        ...
        {/* Product Info */}
        <div className="w-full md:w-1/2 px-4 md:px-6 lg:px-12 flex flex-col">
          ...
          <button className="w-full md:w-1/2 px-6 py-3 bg-teal-600 text-white rounded-lg text-lg font-semibold">
            Add To Cart
          </button>
        </div>
      </div>
