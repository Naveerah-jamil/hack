      ...
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mt-8 text-sm text-gray-500">
          ...
          <div className="flex items-center space-x-4 mt-4 lg:mt-0">
            <Image src="/paypal-logo.png" alt="PayPal" width={60} height={24} />
            <Image src="/visa-logo.png" alt="Visa" width={60} height={24} />
            <Image src="/company-logo.png" alt="Company Logo" width={60} height={24} />
          </div>
        </div>
      </div>
    </footer>
